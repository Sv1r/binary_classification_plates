...
# MobileNet_v3_small
mobilenet_v3_small = torchvision.models.mobilenet_v3_small(weights=torchvision.models.MobileNet_V3_Small_Weights.DEFAULT)
for param in mobilenet_v3_small.parameters():
    param.requires_grad = False
mobilenet_v3_small.classifier[3] = torch.nn.Linear(mobilenet_v3_small.classifier[3].in_features, 2)
# vit_16
...
models_list = [resnet18, mobilenet_v3_small, vit_16]
models_names = ['ResNet18', 'MobileNet_v3_small', 'ViT_16']
